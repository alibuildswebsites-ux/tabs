    ...
    <>
      ...
      <section className="pt-28 pb-16 px-6 text-center">
        <div className="max-w-2xl mx-auto flex flex-col items-center gap-5">
          ...
          <h1 className="text-heading-sm md:text-heading lg:text-display font-medium leading-display tracking-display text-midnight-ink">
            Let&apos;s Talk About Your Finances
          </h1>
          <p className="text-body md:text-body-lg text-muted-stone max-w-xl leading-body-lg tracking-body-lg">
      ...
      <section className="py-8 md:py-12 px-6">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-20 items-start">
          ...
          <div className="lg:col-span-3 bg-ghostly-gray rounded-cards p-8 md:p-12">
            <h2 className="text-heading-sm font-medium text-midnight-ink mb-6">Send Us a Message</h2>
            <ContactForm />
          </div>
          ...
          <div className="lg:col-span-2 flex flex-col gap-8">
            ...
            <div className="flex flex-col gap-4">
              <h2 className="text-heading-sm font-medium text-midnight-ink">Prefer to Book a Call?</h2>
              <p className="text-body text-muted-stone leading-body tracking-body">
            ...
            <div className="bg-sunbeam-yellow rounded-[16px] p-6 flex flex-col gap-2">
              <p className="text-midnight-ink font-medium text-body">No obligation, ever.</p>
              <p className="text-midnight-ink/70 text-sm leading-body tracking-body">
